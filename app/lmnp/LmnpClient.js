...
const MicroVsReelChart   = dynamic(() => import("./LmnpCharts").then(m => m.MicroVsReelChart),   { ssr:false, loading: ChartLoading });
const CashflowChart      = dynamic(() => import("./LmnpCharts").then(m => m.CashflowChart),      { ssr:false, loading: ChartLoading });
const BouclierFiscalChart = dynamic(() => import("./LmnpCharts").then(m => m.BouclierFiscalChart), { ssr:false, loading: ChartLoading });
...
/* ════════════════════════════════════════
   MOTEURS DE CALCUL — déplacés dans lib/calcul-lmnp.js
   Importés en tête de fichier via @/lib/calcul-lmnp
════════════════════════════════════════ */
...
/* MicroVsReelChart, CashflowChart, BouclierFiscalChart, PatrimoineChart,
   AchatVsEpargneChart → déplacés dans LmnpCharts.js (import dynamique) */
